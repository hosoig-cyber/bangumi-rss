...
#A    },
    ...
    "tv_nhk": {
        "queries": ["魔改造の夜","バス乗り継ぎ旅W","バス乗り継ぎ旅Ｗ","素っ頓狂な夜","糸井重里","みうらじゅん","バックパッカー世界さすらいメシ","植物男子","いとうせいこう","寄生番組","チョイ住み","バス旅W"],          # OR条件
        "genres": {"バラエティ","映画","ドラマ","情報／ワイドショー","ニュース／報道","ドキュメンタリー／教養","劇場／公演","趣味／教育","音楽","スポーツ"},
    ...
    ## スポーツ
    "tv_suports": {
        "queries": ["バスケットボール","女子バレー","ラグビー","Bリーグ","女子マラソン","女子駅伝","バレー女子","陸上","マラソン女子","群馬グリーンウイングス"],          # OR条件
        "genres": {"バラエティ","情報／ワイドショー","ニュース／報道","ドキュメンタリー／教養","スポーツ"},
        "exclude_titles": [],
    ...
    "tv_hinata_og": {
        "queries": ["佐々木久美","加藤史帆","斉藤京子","佐々木美鈴","影山優佳","丹生明里","佐々木美玲","松田好花","渡邉美穂","濱岸ひより","富田鈴花","宮田愛萌","高本彩花","河田陽菜"],          # OR条件
        "genres": {"バラエティ","映画","ドラマ","情報／ワイドショー","ニュース／報道","ドキュメンタリー／教養","劇場／公演","趣味／教育","音楽","スポーツ"},
