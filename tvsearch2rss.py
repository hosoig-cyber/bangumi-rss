...
#A    },
    ...
    "tv_nhk": {
        "queries": ["魔改造の夜","バス乗り継ぎ旅W","素っ頓狂な夜","糸井重里","みうらじゅん","バックパッカー世界さすらいメシ","植物男子","いとうせいこう","寄生番組","チョイ住み","バス旅W","プロ野球順位予想"],          # OR条件
        "genres": {"バラエティ","映画","ドラマ","情報／ワイドショー","ニュース／報道","ドキュメンタリー／教養","劇場／公演","趣味／教育","音楽","スポーツ"},
        "exclude_titles": ["新TV見仏記","ボタニカルを愛でたい","3ヵ月でマスターする"],
        "rss_file": "02_02tv_nhk.xml",
    },
    
    ## スポーツ
    "tv_suports": {
        "queries": ["バスケットボール","女子バレー","ラグビー","Bリーグ","女子マラソン","女子駅伝","バレー女子","陸上","マラソン女子","群馬グリーンウイングス","UFC"],          # OR条件
        "genres": {"バラエティ","情報／ワイドショー","ドキュメンタリー／教養","スポーツ"},
        "exclude_titles": ["バスケ魂","プライムニュース","S☆1","Going","And　One"],
    ...
    "tv_sansiro": {
     ...
     "tv_audry": {
        "queries": ["オードリー","若林正恭"],          # OR条件
        "genres": {"バラエティ","ドラマ","情報／ワイドショー","ニュース／報道","ドキュメンタリー／教養","劇場／公演","趣味／教育","音楽","スポーツ"},
        "exclude_titles": ["ソレダメ","スクール革命","ベスコングルメ","アンパラレルド","知らない街で自腹","綾小路きみまろTV","ネプリーグ","サタプラ","いくらかわかる金","字幕"],
     ...
     "tv_oota": {
        ...
        "genres": {"バラエティ","映画","ドラマ","情報／ワイドショー","ニュース／報道","ドキュメンタリー／教養","劇場／公演","趣味／教育","音楽","スポーツ"},
        "exclude_titles": ["サンデー・ジャポン","バズ英語","太田光代","デララバ"],
        "rss_file": "04_10tv_oota.xml",
    },
      "tv_kisitakano": {
        "queries": ["きしたかの"],          # OR条件
        "genres": {"バラエティ","映画","ドラマ","情報／ワイドショー","ニュース／報道","ドキュメンタリー／教養","劇場／公演","趣味／教育","音楽","スポーツ"},
        "exclude_titles": ["バナナサンド"],
    ...
    "tv_hinata_og": {
        "queries": ["佐々木久美","加藤史帆","斉藤京子","佐々木美鈴","影山優佳","丹生明里","松田好花","渡邉美穂","濱岸ひより","富田鈴花","宮田愛萌","高本彩花","河田陽菜"],          # OR条件
        "genres": {"バラエティ","映画","ドラマ","情報／ワイドショー","ニュース／報道","ドキュメンタリー／教養","劇場／公演","趣味／教育","音楽","スポーツ"},
        "exclude_titles": ["ウェル美","シネマアディクト","シネクラ","推しエンタTV","土曜は寅さん"],
      ...
      "tv_sisonnu": {
        ...
        "exclude_titles": ["有吉の壁","シソンヌ長谷川","何かオモシロいコトないの"],
        "rss_file": "04_18tv_sisonnu.xml",
    },
    "tv_sandwitch": {
        "queries": ["伊達みきお","富澤たけし"],          # OR条件
        "genres": {"バラエティ","映画","ドラマ","ドキュメンタリー／教養","劇場／公演","趣味／教育","音楽","スポーツ"},
        "exclude_titles": ["突破ファイル","帰れマンデー見っけ隊","バナナサンド","坂上どうぶつ王国","コロッケあがってます","ウワサのお客さま","月夜行路"],
        "rss_file": "04_19tv_sandwitch.xml",
    },
    "tv_sakuraog": {
        "queries": ["関有美子","小林由依","井上梨名","守屋茜","尾関梨香","渡邉理佐","櫻坂46"],          # OR条件
        "genres": {"バラエティ","映画","ドラマ","ドキュメンタリー／教養","劇場／公演","趣味／教育","音楽","スポーツ"},
        "exclude_titles": [],
    ...
    "tv_rainbow": {
        ...
        "genres": {"バラエティ","映画","ドラマ","ドキュメンタリー／教養","劇場／公演","趣味／教育","音楽","スポーツ"},
        "exclude_titles": ["アッコとジャンボ","沼にハマってきいてみた"],
